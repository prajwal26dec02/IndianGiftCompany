...
const  Cart = () => {
  ...
  const deleteCart = (item) => {
    ...
    toast.success('Item sucessfully removed from cart');
  }
  ...
  const buyNow = async () => {
    // validation 
    if (userName === "" || address == "" || pincode == "" || phone == "") {
    ...
    var options = {
      key: "rzp_test_68DG2MSToV5IVG",
      key_secret: "r6nW4YXM9yHd4dE6L8ZXp3P3",
      amount: parseInt(grandTotal * 100),
      currency: "INR",
      order_receipt: 'order_rcptid_' + userName,
      name: "TheIndianGiftCompany",
      ...
      <div className="h-screen bg-gray-100 pt-5 " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <Modal userName={userName} address={address} pincode={pincode} phone={phone} setUserName={setUserName} setAddress={setAddress} setPincode={setPincode} setPhone={setPhone} buyNow={buyNow} />
