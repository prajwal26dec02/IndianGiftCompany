...
const DashboardTab=()=> {
    ...
    const { mode, product,editHandle,deleteProduct, order,user, searchkey, setSearchkey, filterType, setFilterType, filterPrice, setFilterPrice } = context
                    ...
                    <Tabs defaultIndex={0} className=" " >
                        ...
                        <TabPanel>
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className=" flex justify-end">
                                   ...
                                   <button
                                        type="button"
                                        className="focus:outline-none text-white bg-green-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'Dark' ? 'rgb(46 49 55)' : '', color: mode === 'Dark' ? 'white' : '', }} > <div className="flex gap-2 items-center" onClick={add}>
                        ...
                        <TabPanel>
                            ...
                            {order.map((allorder,index)=>{
                                return(
                                    <div key={index} className="relative overflow-x-auto mb-16">
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'Dark' ? 'white' : '' }}>Order Details</h1>
                                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                            ...
                                            {allorder.cartItems.map((item,index)=>{
                                                const{imageUrl,title,description,price,category}=item;
                                                return(
                                                    <tbody key={index}>
