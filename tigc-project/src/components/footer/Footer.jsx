            ...
            <div className="bg-gray-200" style={{ backgroundColor: mode === 'Dark' ? 'rgb(55 57 61)' : '', color: mode === 'Dark' ? 'white' : '', }}>
                <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                    <Link to={'/'} className='flex'>
                        <div className="flex ">
                            <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'Dark' ? 'white' : '', }}>The Indian Gift Company</h1>
                        </div>
                    </Link>
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4" style={{ color: mode === 'Dark' ? 'white' : '' }}>© 2023 The Indian Gift Company —
                        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank" style={{ color: mode === 'Dark' ? 'white' : '' }}>www.theindiangiftcompany.com</a>
                    </p>
